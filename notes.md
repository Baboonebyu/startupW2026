...
## Database
This wasn't too hard. I just went over databases in my 240 class. It was a little hard to get them to start saving at first and to get the auth token to be removed but once I figured it out the rest came super easy. Hopefully I have enough commits. This was much faster. Also i had to add so awaits toi the code to get it to load. I ran into an issue were it would just freeze without them. AI helped me find where I had missed them. It is really cool how close to being done I am. Although I wish I would have had it done yesterday as I was showing a bunch of people and I lost there scores.